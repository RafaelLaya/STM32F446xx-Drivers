...
#define USART_STATUS_READY							2

/*
 * Events
 */
#define USART_EV_CTS				0
#define USART_EV_ORE				1
#define USART_EV_IDLE				2
#define USART_EV_PE					3
#define USART_EV_LBD				4
#define USART_EV_NF					5
#define USART_EV_FE					6
#define USART_EV_TX_CMPLT			7
#define USART_EV_RX_CMPLT			8
